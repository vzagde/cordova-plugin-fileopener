...
public class FileOpener extends CordovaPlugin {
    ...
    static {
        ...
        MIME_TYPES.put(".pps", "application/vnd.openxmlformats-officedocument.presentationml.slideshow");
        ...
        if (args.length() > 0) {
            ...
            if (url.lastIndexOf(".") > -1) {
                ...
                if (hasMimeType(extension)) {
                    ...
                    obj.put("message", "This extension: " + extension + " is not supported by the FileOpenerrrrrr plugin");
